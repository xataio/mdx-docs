...
```jsonc
// PUT https://{workspace}.{region}.xata.sh/db/{db}:{branch}/tables/{table}/data/rec_c8hnbch26un1nl0rthkg
...
```jsonc
// PATCH https://{workspace}.{region}.xata.sh/db/{db}:{branch}/tables/{table}/data/myid
...
```jsonc
// PATCH https://{workspace}.{region}.xata.sh/db/{db}:{branch}/tables/{table}/data/rec_c8hnbch26un1nl0rthkg
