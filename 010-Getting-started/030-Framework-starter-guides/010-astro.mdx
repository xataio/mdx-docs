...
<html lang="en">
  <head>
    ...
    <title>{title}</title> // [!code highlight]
    <style>
      :root {
...
---
import MainLayout from '../../layouts/main.astro' // [!code highlight]

import { XataClient } from '../../xata'; // [!code highlight]

export async function getStaticPaths() { // [!code highlight]
  const xata = new XataClient({ // [!code highlight]
    apiKey: import.meta.env.XATA_API_KEY, // [!code highlight]
    branch: import.meta.env.XATA_BRANCH // [!code highlight]
  }); // [!code highlight]
  const posts = await xata.db.Posts.getAll(); // [!code highlight]
 // [!code highlight]
  const routes = posts.map(({ slug, title, description, pubDate }) => { // [!code highlight]
    return { // [!code highlight]
      params: { slug }, // [!code highlight]
      props: { title, description, pubDate }, // [!code highlight]
    }; // [!code highlight]
  }); // [!code highlight]
 // [!code highlight]
  return routes; // [!code highlight]
} // [!code highlight]

const post = Astro.props; // [!code highlight]
--- // [!code highlight]
 // [!code highlight]
<MainLayout title={post.title}> // [!code highlight]
 // [!code highlight]
  <div class="w-full max-w-5xl mt-16"> // [!code highlight]
    <p class="mb-2"> // [!code highlight]
      <a href="/" class="text-purple-600"> // [!code highlight]
        &larr; Back to blog // [!code highlight]
      </a> // [!code highlight]
    </p> // [!code highlight]
 // [!code highlight]
    <h1 class="text-3xl mb-2">{post?.title}</h1> // [!code highlight]
    <p class="text-sm mb-4 text-purple-950 dark:text-purple-200"> // [!code highlight]
      {post?.pubDate?.toDateString()} // [!code highlight]
    </p> // [!code highlight]
    <p class="text-xl">{post?.description}</p> // [!code highlight]
 // [!code highlight]
  </div> // [!code highlight]
 // [!code highlight]
</MainLayout> // [!code highlight]
...
const search = Astro.url.searchParams.get('q')! || ''; // [!code highlight]
...
<MainLayout title="Get started with Xata and Astro"> // [!code highlight]
  <div class="w-full max-w-5xl mt-16"> // [!code highlight]
    <form action="/"> // [!code highlight]
      <input // [!code highlight]
        name="q" // [!code highlight]
        value={search} // [!code highlight]
        placeholder="Search..." // [!code highlight]
        class="w-full rounded-lg border-2 p-2 dark:text-purple-950" // [!code highlight]
      /> // [!code highlight]
    </form> // [!code highlight]
  </div>
