...
While Xata is built on top of PostgreSQL, it is not a typical PostgreSQL DBaaS, but a _data platform for PostgreSQL_. The following are the characteristics of the data platform:
...
- Via the [Postgres wire protocol](/docs/postgres/connect), using any Postgres client, ORM, or BI tool.
