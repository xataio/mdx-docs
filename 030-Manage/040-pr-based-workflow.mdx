...
<Alert status="warning">
  ...
  but no further enhancements are planned. This page is specifically about Xata Lite. See
  [xata.io](https://xata.io/postgres-branching) for our more general take on this problem space.
</Alert>
...
### Link your Xata Lite account to your GitHub account
...
### Install the Xata Lite integration for GitHub
...
### Install the Xata Lite integration for Vercel or Netlify
...
### Initialize Xata Lite and create a branch
...
- If your main branch database is under 10,000 rows, all your data will get copied. This includes columns with sensitive data.
