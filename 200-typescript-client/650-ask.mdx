---
title: Ask AI-powered questions of your Data using TypeScript
navTitle: Ask AI
keywords: ["ai", "ask", "artificial intelligence" "typescript", "openai", "open ai"]
description: Code examples for how to add AI querying to your data using TypeScript
