...
3.  **Install linter:** Run `pnpm install` to lint your code and align with style standards. If this is not done your pull request will fail some checks.
...
To fix issues from linting, locate the exact error message that references the specific line number of tf the error. Examine the code or documentation related to the error and ensure the syntax and usage align with coding and documentation standards.
...
You can use Visual Studio Code (VS Code) to write documentation. VS Code includes a built-in Markdown previewer that you can use to view your changes locally.
