...
If the error persists, contact us in Discord or use community resources for guidance.
...
The style guide provides guidance on formatting and writing for Xata documentation. The Formatting Style Guide focuses on visual presentation, covering headings, fonts, bullet points, tables, and diagrams to ensure consistency and clarity. The Writing Style Guide addresses language, emphasizing clear, concise, and plain language use while avoiding unnecessary jargon and technical terms.
...
The following offers guidance on writing in our technical documentation. We follow common language rules found in [technical documentation style guides](https://github.com/MicrosoftDocs/microsoft-style-guide/tree/main).
