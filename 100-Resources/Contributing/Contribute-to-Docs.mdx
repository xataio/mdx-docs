...
<Alert status="info">
  Basic Git, GitHub, and Markdown knowledge is assumed. The documentation site is hosted on Vercel, uses MDX syntax, and
  has heavy use of linters such as ES linter, prettier, and remark.
</Alert>
