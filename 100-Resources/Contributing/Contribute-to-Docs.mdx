...
<Alert status="info">
Basic Git, GitHub, and Markdown knowledge is assumed. The documentation site is hosted on Vercel, uses MDX syntax, and has heavy use of linters such as ES linter, prettier, and remark.
</Alert>
...
This guide provides some guidance on how to create and format documents using MDX (Markdown Extended) for Xata's documentation. It covers some of the aspects of using frontmatter, structuring your documents effectively, and incorporating unique elements specific to MDX. This ensures that all documentation created for Xata adheres to a consistent standard. 
