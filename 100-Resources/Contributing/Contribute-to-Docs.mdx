...
Titles of for procedures should begin with a verb, for example, "Configure", "Use", or "Install".
...
Here are the accepted types of admonitions:
 ...
 This provides extra guidance or advice to enhance product setup, performance, or supportability.
