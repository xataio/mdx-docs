...
description: Create a gallery app of large binary objects and uses searchable file metadata
slug: examples/gallery-app
published: true
---

Build a gallery application using Xata's File Attachment feature, which integrates file support directly into the database. You'll benefit from a unified experience for handling large binary objects, and enabling searchable and queryable file metadata.
