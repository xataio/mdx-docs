...
- [Typo-tolerant, fuzzy search](/docs/developer-guide/typescript-client/search)
- [Aggregations](/docs/developer-guide/typescript-client/aggregate)
- [Type-safe SDK/ORM](/docs/developer-guide/typescript-client/overview) (schema-based types generation)
- Edge-ready

## Components

- [Zod](https://zod.dev) - TypeScript-first runtime validation library for schema validation.
- [Xata client](https://xata.io/docs/developer-guide/cli)- Object-relational mapping (ORM) with the SDK to handle data manipulation, querying, and other database-related tasks.
