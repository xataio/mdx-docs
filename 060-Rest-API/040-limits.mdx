...
| Offset pagination size  | 50,000 records |
...
- Log and track errors in your application error channels or log streams in order to monitor for throttling errors, so you can make informed decisions for whether to upgrade your plan.
