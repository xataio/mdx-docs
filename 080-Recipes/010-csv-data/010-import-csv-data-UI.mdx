...
- [Import a CSV file using the Xata UI](/recipes/csv-data/import-data-ui#import-a-csv-file-using-the-ui) (recommeneded)
- [Import a CSV file using the Xata CLI](/recipes/csv-data/import-data-cli)
