...
- [Import a CSV file using the Xata UI](/docs/recipes/csv-data/import-data#import-a-csv-file-using-the-ui) (recommended)
...
1.  Choose the preferred branch for your work.
1.  In the left-hand menu under "Tables," click **Add a table** > **Import a CSV file**.
    ![Import CSV files](../images/import-csv-file.png)
1.  Select **Browse Desktop** to choose a supported file to import. Ensure the filename adheres to the formatting recommendations.
1.  The Xata importer can guess column types from you imported data. If needed, choose column types from the drop-down list and rename columns. The column type cannot be changed after import. You can edit column names after importing.
1. Click **Begin import** to initiate the import. You'll have access to partially imported records as the process completes.
