...
Ask AI runs in the optional Search store which is eventually consistent. You can choose to opt-out from the Search store at the branch level in the Web UI. The ask API and features described in this page require the Search store to be enabled.
