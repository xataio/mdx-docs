...
https://us-east-1.storage.xata.sh/71rs0ffso94k1e1982f9e3dqco

Image URL with transformations:

https://us-east-1.storage.xata.sh/transform/rotate=180,height=100,format=webp/s38lomas915pn3vetrp1gomd7g

<TransformImageExample
  url="https://us-east-1.storage.xata.sh/71rs0ffso94k1e1982f9e3dqco"
...
```python
img = xata.files().transform("https://us-east-1.storage.xata.sh/71rs0ffso94k1e1982f9e3dqco", {
  "height": 100,
  "rotate": 180,
  "format": "webp"
})
...
```txt
https://us-east-1.storage.xata.sh/transform/height=50,format=webp/s38lomas915pn3vetrp1gomd7g
```
...
const transformedImageUrl = transformImage('https://us-east-1.storage.xata.sh/71rs0ffso94k1e1982f9e3dqco', {
  height: 100,
  rotate: 180
  format: 'webp',
});
...
```ts
const transformedImageUrl = transformImage('https://us-east-1.storage.xata.sh/e089frhoe50pf3b8kekg5e941k', {
  anim: false,
  format: 'auto'
});
```
...
```python
img = xata.files().transform("https://us-east-1.storage.xata.sh/e089frhoe50pf3b8kekg5e941k", {
  "anim": false,
  "format": "auto"
})
```
...
```txt
https://us-east-1.storage.xata.sh/transform/anim=false,format=auto/s38lomas915pn3vetrp1gomd7g
```

</TabbedCode>

<TransformImageExample
  url="https://us-east-1.storage.xata.sh/e089frhoe50pf3b8kekg5e941k"
...
```txt
https://us-east-1.storage.xata.sh/transform/background=red/s38lomas915pn3vetrp1gomd7g
```
...
```txt
https://us-east-1.storage.xata.sh/transform/blur=50/s38lomas915pn3vetrp1gomd7g
```

</TabbedCode>

<TransformImageExample url="https://us-east-1.storage.xata.sh/71rs0ffso94k1e1982f9e3dqco" options={{ blur: 50 }} />
...
```txt
https://us-east-1.storage.xata.sh/transform/brightness=0.5/s38lomas915pn3vetrp1gomd7g
```
...
```txt
https://us-east-1.storage.xata.sh/transform/compression=fast/s38lomas915pn3vetrp1gomd7g
```
...
```txt
https://us-east-1.storage.xata.sh/transform/contrast=0.5/s38lomas915pn3vetrp1gomd7g
```

</TabbedCode>

<TransformImageExample url="https://us-east-1.storage.xata.sh/71rs0ffso94k1e1982f9e3dqco" options={{ contrast: 0.5 }} />
...
```txt
https://us-east-1.storage.xata.sh/transform/dpr=2,height=200,fit=contain/s38lomas915pn3vetrp1gomd7g
```
...
```python
# Note that the rendered example retains the original aspect-ratio
transformed_image = xata.files().transform("https://us-east-1.storage.xata.sh/71rs0ffso94k1e1982f9e3dqco", {
  "width": 100,
  "height": 100,
  "fit": "contain"
})
...
<TabbedCode tabs={['TypeScript', 'Python']}>
```ts
// Notice that the rendered example does not grow to 1000px
const transformedImageUrl = transformImage('https://us-east-1.storage.xata.sh/71rs0ffso94k1e1982f9e3dqco', {
  width: 100,
  height: 100,
  fit: 'scale-down'
...
<TabbedCode tabs={['TypeScript', 'Python']}>
```ts
// Notice that the rendered example does not grow to 250 and maintain its original size
const transformedImageUrl = transformImage('https://us-east-1.storage.xata.sh/71rs0ffso94k1e1982f9e3dqco', {
  width: 250,
  height: 250,
  fit: 'scale-down'
...
<TransformImageExample
  url="https://us-east-1.storage.xata.sh/71rs0ffso94k1e1982f9e3dqco"
  options={{ height: 250, width: 250, fit: 'scale-down' }}
/>
...
<TransformImageExample
  url="https://us-east-1.storage.xata.sh/71rs0ffso94k1e1982f9e3dqco"
  options={{ height: 250, width: 250, fit: 'pad', background: 'red' }}
/>
...
```txt
https://us-east-1.storage.xata.sh/transform/format=webp/s38lomas915pn3vetrp1gomd7g
```
...
Here is an example of outputing `JSON`, which will give you dimensions of the transformed image along with details from the original.
...
```txt
https://us-east-1.storage.xata.sh/transform/format=json,height=100/s38lomas915pn3vetrp1gomd7g
```

</TabbedCode>

Check the resulting JSON at https://us-east-1.storage.xata.sh/transform/format=json,height=100/s38lomas915pn3vetrp1gomd7g
...
```txt
https://us-east-1.storage.xata.sh/transform/gamma=0.5/s38lomas915pn3vetrp1gomd7g
```

</TabbedCode>

<TransformImageExample url="https://us-east-1.storage.xata.sh/71rs0ffso94k1e1982f9e3dqco" options={{ gamma: 0.5 }} />
...
```txt
https://us-east-1.storage.xata.sh/transform/height=100/s38lomas915pn3vetrp1gomd7g
```

</TabbedCode>

<TransformImageExample url="https://us-east-1.storage.xata.sh/71rs0ffso94k1e1982f9e3dqco" options={{ height: 100 }} />
...
```txt
https://us-east-1.storage.xata.sh/transform/metadata=none/s38lomas915pn3vetrp1gomd7g
```
...
```txt
https://us-east-1.storage.xata.sh/transform/quality=50/s38lomas915pn3vetrp1gomd7g
```

</TabbedCode>

<TransformImageExample url="https://us-east-1.storage.xata.sh/71rs0ffso94k1e1982f9e3dqco" options={{ quality: 10 }} />
...
```txt
https://us-east-1.storage.xata.sh/transform/rotate=90/s38lomas915pn3vetrp1gomd7g
```

</TabbedCode>

<TransformImageExample url="https://us-east-1.storage.xata.sh/71rs0ffso94k1e1982f9e3dqco" options={{ rotate: 90 }} />
...
```txt
https://us-east-1.storage.xata.sh/transform/sharpen=2/s38lomas915pn3vetrp1gomd7g
```

</TabbedCode>

<TransformImageExample url="https://us-east-1.storage.xata.sh/71rs0ffso94k1e1982f9e3dqco" options={{ sharpen: 2 }} />
...
<TabbedCode tabs={['TypeScript', 'Python', 'URL']}>
```ts
const transformedUrl = transformImage('https://us-east-1.storage.xata.sh/71rs0ffso94k1e1982f9e3dqco', {
  trim: {
    top: 20,
    right: 30,
    bottom: 20,
...
```txt
https://us-east-1.storage.xata.sh/transform/trim=20;30;20;0/s38lomas915pn3vetrp1gomd7g
```
...
```txt
https://us-east-1.storage.xata.sh/transform/width=100/s38lomas915pn3vetrp1gomd7g
```

</TabbedCode>

<TransformImageExample url="https://us-east-1.storage.xata.sh/71rs0ffso94k1e1982f9e3dqco" options={{ width: 100 }} />
