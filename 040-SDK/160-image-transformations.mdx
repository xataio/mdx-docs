...
```python
img = xata.files().transform("s38lomas915pn3vetrp1gomd7g", {
  "height": 50,
  "format": "webp"
})
```
...
```sh
curl 'https://us-east-1.storage.xata.sh/s38lomas915pn3vetrp1gomd7g' \
...
```ts
const transformedUrl = transformImage('https://some/xata/imageurl', {
  trim: {
    top: 20,
    right: 30,
    bottom: 20,
