...
Option to force browser to download the image instead of displaying it. This is useful for images that you want to be downloaded by default.
...
```txt
https://us-east-1.storage.xata.sh/transform/download=xata-cat.jpg,format=jpg/4u1fh2o6p10blbutjnphcste94
```
