...
```txt
https://us-east-1.storage.xata.sh/transform/background=pink/4u1fh2o6p10blbutjnphcste94
```
...
```txt
https://us-east-1.storage.xata.sh/transform/blur=50/4u1fh2o6p10blbutjnphcste94
```
