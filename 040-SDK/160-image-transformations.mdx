...
Option to force browser to [download](https://us-east-1.storage.xata.sh/transform/download=xata-cat.jpg,format=jpeg/4u1fh2o6p10blbutjnphcste94) the image instead of displaying it. Value is the file name and extension is optional.
