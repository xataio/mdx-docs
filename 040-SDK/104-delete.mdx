...
To avoid the SQL proxy's 60-second timeout, delete in small batches. It is recommended to delete no more than 10,000 records per batch. You can use a nested `SELECT` statement to manage batch sizes efficiently and prevent timeouts.
