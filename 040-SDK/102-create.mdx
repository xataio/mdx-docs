...
If you have multiple records to insert, you can send them in a single request via the [`/bulk` endpoint](/docs/api-reference/db/db_branch_name/tables/table_name/bulk#bulk-insert-table-records). For example:
