...
<<Alert status="warning">
  This feature is deprecated and no longer recommended for use in new applications. It will continue to be maintained, but no further enhancements are planned. As of January 10, 2025 this feature is only available on the [Pro and Enterprise plans](/blog/changes-free-tier).
</Alert>
