...
> NOTE: Pagination is limited to a total possible retrieval of 50,000 records.
...
xata.table().create("mytable")

set_table_schema_resp = xata.table().set_schema("mytable", table_schema)

if set_table_schema_resp.is_success():
