...
result = xata.transactions.run([
  ...
  },
  {
    "update": {
      "table": "Users",
      "id": "rec_cmf572veoo9ahn3r96p0",
      # Include the fields to update for this record
    }
  },
...
```go
result, _ := xata.transactions.Run(context.TODO(), []xata.Transaction{
  {
    Update: xata.UpdateTransaction{
      Table: "Users",
      ID:    "rec_cmf56ugvjdkilkpcdeu0",
      Fields: map[string]interface{}{"email": "neo@matrix.com", "name": "Neo"},
    },
  },
  {
    Update: xata.UpdateTransaction{
