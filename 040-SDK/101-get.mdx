...
Furthermore, via the [Kysely integration](/docs/integrations/kysely) the Typescript SDK supports typed SQL statements, including `JOIN`s.
...
<TabbedCode tabs={['TypeScript', 'SQL']}>
