...
client, _ := data.Query(context.Background(), xata.QueryTableRequest{
	TableName: "Teams",
})
```
...
record, _ := client.Get(context.Background(), xata.GetRecordRequest{
...
users, _ := client.Query(context.Background(), xata.QueryTableRequest{
		TableName: "Users",
