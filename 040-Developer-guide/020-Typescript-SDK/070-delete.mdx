...
[Transactions](/docs/developer-guide/typescript-client/transaction) will not fail a delete operation if no record is found. All operations in a transaction must succeed otherwise it is rolled back.

## Next Steps

Now that you have seen how to do the basic create, remove, update, and delete operations, you can check out the docs on using the [free text search API](/docs/developer-guide/typescript-client/search), which is a new super power that Xata gives you.

You can also review the pages on [getting data](/docs/developer-guide/typescript-client/get), [updating data](/docs/developer-guide/typescript-client/update), [inserting data](/docs/developer-guide/typescript-client/insert). We've got guides for each of these operations.
