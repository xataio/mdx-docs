...
The recommended method is to install the [Xata CLI](/docs/developer-guide/cli) globally and import the client from the [code generated](/docs/developer-guide/cli#codegen) by the CLI.
