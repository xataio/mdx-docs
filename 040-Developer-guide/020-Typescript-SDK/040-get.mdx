...
This section contains a few examples of how to use filtering. To find all supported operators and examples for them, see the [Filtering](/docs/developer-guide/typescript-client/filtering) section of the API Guide.
...
To see the rest of the operators available, check out the [Filtering](/docs/developer-guide/typescript-client/filtering) guide.
...
[query functions](/docs/developer-guide/typescript-client/get#the-typescript-sdk-functions-for-querying) section. Only REST API examples are provided in this section.
...
Now that we can get retrieve data from a database, we might be interested in [creating more data](/docs/developer-guide/typescript-client/insert), [updating data](/docs/developer-guide/typescript-client/update) or [deleting data](/docs/developer-guide/typescript-client/delete). We've got guides for each of these operations.
