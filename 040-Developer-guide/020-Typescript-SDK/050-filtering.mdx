...
The same filtering syntax can be used in multiple places, including the [Query API](/docs/developer-guide/typescript-client/get),
the [Search API](/docs/developer-guide/typescript-client/search), and the [Aggregate API](/docs/developer-guide/typescript-client/aggregate). By using the same
...
[Search API](/docs/developer-guide/typescript-client/search) for more powerful full-text-search.
