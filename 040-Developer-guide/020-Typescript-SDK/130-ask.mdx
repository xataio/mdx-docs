...
The options that you can pass under the `search` key mirror a subset of the options from the [search endpoint](/docs/developer-guide/typescript-client/search#searching-in-a-single-table). See that section of the guide for more details.
...
The options that you can pass under the `search` key mirror a subset of the options from the [vector search endpoint](/docs/developer-guide/typescript-client/vector-search). See that section of the guide for more details.
