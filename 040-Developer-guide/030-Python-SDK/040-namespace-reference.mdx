...
Alternatively, you can directly instantiate a namespace, as demonstrated in this [example](/docs/developer-guide/python-sdk/examples#get-a-record-from-a-table).
