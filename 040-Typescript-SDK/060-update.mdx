...
```jsonc
// This method is currently unsupported in the SQL endpoint. 
```
...
{
    "query": "UPDATE \"Users\" SET email = 'newemail@example.com' WHERE id = 'myid' RETURNING *;"
}
```
...
{
    "query": "INSERT INTO \"Users\" (id, name) VALUES ('rec_c8hnbch26un1nl0rthkg', 'susan') ON CONFLICT (id) DO UPDATE SET name = 'Keanu Reeves' RETURNING *;"
}
```
...
{
    "query": "UPDATE \"Users\" SET counter = counter + 1 WHERE id = 'rec_c8hnbch26un1nl0rthkg' RETURNING *;"
}
```
...
{
    "query": "UPDATE \"Users\" SET counter = counter + 10 WHERE id = 'rec_c8hnbch26un1nl0rthkg' RETURNING *;"
}
```
...
{
    "query": "UPDATE \"Users\" SET counter = counter / 2 WHERE id = 'rec_c8hnbch26un1nl0rthkg' RETURNING *;"
}
```
...
{
    "query": "UPDATE \"Users\" SET email = 'keanu@xata.io', name = 'Keanu Reeves' WHERE id = 'rec_c8hnbch26un1nl0rthkg' AND \"xata.version\" = 0 RETURNING *;"
}
```

</TabbedCode>

If someone else has updated the record since you have read it, the Xata API will get a [422 Unprocessable Entity](https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/422) response:
