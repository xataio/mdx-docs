...
{
    "query": "SELECT <columns> from \"table_name\" WHERE <filter> ORDER BY <sort> LIMIT <number>;"
}
```
...
{
    "query": "SELECT * from \"Teams\" LIMIT 20;"
}
```
...
{
    "query": "SELECT name,city from \"Users\" LIMIT 20;"
}
```
...
{
    "query": "SELECT *,\"Users\".* FROM \"Teams\" LEFT JOIN \"Users\" ON \"Teams\".owner=\"Users\".id;"
}
```
...
{
    "query": "SELECT title,\"Users\".*,\"Teams\".* FROM \"Posts\" LEFT JOIN \"Users\" ON \"Posts\".author=\"Users\".id LEFT JOIN \"Teams\" ON \"Users\".team=\"Teams\".id;"
}
```
...
{
    "query": "SELECT * FROM \"Users\" WHERE email='keanu@example.com' LIMIT 20;"
}
```
...
{
    "query": "SELECT * FROM \"Users\" LEFT JOIN \"Teams\" ON \"Users\".team=\"Teams\".id WHERE \"Teams\".name='Matrix';"
}
```
...
{
    "query": "SELECT * FROM \"Users\" WHERE zipcode > 100 AND (name LIKE '%Keanu%' OR name LIKE '%Carrie%') LIMIT 20;"
}
```
...
{
    "query": "SELECT * FROM \"Users\" ORDER BY \"name\" asc LIMIT 20;"
}
```
...
{
    "query": "SELECT * FROM \"Users\" ORDER BY \"city\" desc, \"name\" asc LIMIT 20;"
}
```
...
{
    "query": "SELECT * FROM \"Users\" ORDER BY RANDOM() LIMIT 20;"
}
```
...
<TabbedCode tabs={['TypeScript', 'Python', 'JSON', 'SQL']}>
```ts
const page = await xata.db.Users.getPaginated({
