...
{
    "query": "DELETE FROM \"Users\" WHERE id = 'rec_cd8s3r8avc42pi67m13g';"
}
```

</TabbedCode>

In case the record with the given ID doesn't exist, the Xata REST API returns a 404 and the TypeScript SDK throws an exception.
...
{
    "query": "DELETE FROM \"Users\" WHERE id IN ('rec_cd8s3r8avc42pi67m13g','rec_cgh9o1oncchhigq95n2g');"
}
```
