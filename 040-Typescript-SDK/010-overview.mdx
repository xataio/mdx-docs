...
We recommend installing the [Xata CLI](/docs/developer-guide/cli) globally and import the Xata Client from the [code generated](/docs/developer-guide/cli#codegen) by the CLI.
