...
The SDK provides helper methods for creating types based off of the Xata client-generated types, exported on the @xata.io/client package: `SelectedPick` , `SelectableColumn` and `EditableData`.
