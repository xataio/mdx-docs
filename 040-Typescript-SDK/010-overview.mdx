...
The SDK provides helper methods for creating types based off of Xata types, exported on the @xata.io/client package: `SelectedPick` , `SelectableColumn` and `EditableData`.
