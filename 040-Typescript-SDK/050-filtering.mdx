...
{
    "query": "SELECT * FROM \"Users\" WHERE name = 'Keanu Reeves' LIMIT 20;"
}
```
...
{
    "query": "SELECT * FROM \"Users\" WHERE name IN ('Keanu Reeves','Carrie-Anne Moss') LIMIT 20;"
}
```
...
{
    "query": "SELECT * FROM \"Users\" WHERE name = 'Keanu Reeves' AND city = 'New York' LIMIT 20;"
}
```
...
{
    "query": "SELECT * FROM \"Users\" WHERE name = 'Keanu Reeves' OR city = 'New York' LIMIT 20;"
}
```
...
{
    "query": "SELECT * FROM \"Users\" WHERE name = 'Keanu Reeves' OR name = 'Carrie-Anne Moss' LIMIT 20;"
}
```
...
{
    "query": "SELECT * FROM \"Users\" WHERE name IS NOT NULL LIMIT 20;"
}
```
...
{
    "query": "SELECT * FROM \"Users\" WHERE (name IS NOT NULL) AND (address IS NOT NULL) LIMIT 20;"
}
```
...
{
    "query": "SELECT * FROM \"Users\" WHERE name IS NULL LIMIT 20;"
}
```
...
{
    "query": "SELECT * FROM \"Users\" WHERE NOT name = 'Keanu Reeves' LIMIT 20;"
}
```
...
{
    "query": "SELECT * FROM \"Users\" WHERE NOT (name = 'Keanu Reeves' OR name = 'Laurence Fishburne') LIMIT 20;"
}
```
...
{
    "query": "SELECT * FROM \"Users\" WHERE name NOT IN ('Keanu Reeves','Laurence Fishburne') LIMIT 20;"
}
```
...
{
    "query": "SELECT * FROM \"Users\" WHERE name LIKE '%Keanu%' LIMIT 20;"
}
```
</TabbedCode>
...
{
    "query": "SELECT * FROM \"Users\" WHERE name ~ 'K.*an.? R.*' LIMIT 20;"
}
```
...
{
    "query": "SELECT * FROM \"Users\" WHERE name ~ '^Keanu' LIMIT 20;"
}

// or

{
    "query": "SELECT * FROM \"Users\" WHERE name ~ 'Reeves$' LIMIT 20;"
}
```
...
{
    "query": "SELECT * FROM \"Users\" WHERE views > 5 LIMIT 20;"
}
```
...
{
    "query": "SELECT * FROM \"Users\" WHERE \"xata.createdAt\"::timestamptz < '2022-10-25T02:00:00.000Z' AND \"xata.createdAt\"::timestamptz >= '2022-10-25T01:00:00.000Z' LIMIT 20;"
}
```
...
{
    "query": "SELECT * FROM \"Users\" WHERE 'matrix' = ANY (labels);"
}
```
