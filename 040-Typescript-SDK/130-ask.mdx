...
When you use the endpoint, Xata finds the most relevant fields matching your search query and sends them in fragments or in their entirety to OpenAI. This process is carried out on a per-request basis. Data is not synced on any kind of schedule. Only the data in the table you're searching for, and matching the parameters you provide, will be sent.
