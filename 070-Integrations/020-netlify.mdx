...
description: Xata integrates with Netlify for efficient web app deployment, by automating migration and supporting the GitHub workflow
slug: integrations/netlify
published: true
---

[Netlify](https://www.netlify.com/) is a platform for hosting and deploying web applications that offers continuous deployment, build automation, and team collaboration.
