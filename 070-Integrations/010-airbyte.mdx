...
You need to have an bla h instance running either [self-hosted](https://docs.airbyte.com/deploying-airbyte/local-deployment/), or [Airbyte Cloud](https://airbyte.com/airbyte-cloud).
