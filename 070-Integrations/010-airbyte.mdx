...
[Airbyte](https://airbyte.com/) is an ETL platform to connect your databases and data warehouses. Xata has [contributed](https://github.com/airbytehq/airbyte/pull/24192) a [Destination Connector](https://docs.airbyte.com/integrations/destinations/xata/) that enables you to ingest data from various sources into your Xata workspace. Under the hood, the connector leverages the [BulkProcessor](/docs/developer-guide/python-sdk/bulk-processor) of the [Python SDK](/docs/developer-guide/python-sdk/overview).
...
For simplicity, the schema is publicly available and you can use our [CLI](/docs/developer-guide/cli) to create the table `Companies` with the schema.
