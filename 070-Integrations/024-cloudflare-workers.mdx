...
```sh
npm create cloudflare@latest xata-cloudflare
```

After the command has completed, navigate to the `xata-cloudflare` directory, and run the application locally:
...
3.  Under Settings tab > Variables > Add variable
