...
- [Using the Cloudflare dashboard (UI method)](/docs/integrations/cloudflare/#integrate-using-the-dashboard): This approach involves using the Cloudflare dashboard for configuration.
