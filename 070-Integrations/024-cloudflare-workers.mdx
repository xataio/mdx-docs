...
Will link off to getting started section maybe
...
There are two ways of initiailizing the xata client with cloudflare workers: "Service Worker" format and "ES Modules" format. We recommend using the modules syntax.
