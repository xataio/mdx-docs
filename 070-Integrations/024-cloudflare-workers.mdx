...
<ArticleVideo
  platform="html"
  src="https://github.com/xataio/mdx-docs/raw/feat/getting-started-cloudflare-workers/070-Integrations/videos/cf-integration.mp4"
  autoplay
  loop
/>
...
Please follow [Cloudflare's docs](https://developers.cloudflare.com/workers/configuration/environment-variables/#add-environment-variables-via-the-dashboard) for manually adding environment variables via the dashboard.
