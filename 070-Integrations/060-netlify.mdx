...
To use Xata in [Edge Functions](https://docs.netlify.com/edge-functions/overview/):

- Import the Xata client via an [import map](https://docs.netlify.com/edge-functions/api/#import-maps)

Create a `deno.json` file in your project's root directory to import the xata client file:
