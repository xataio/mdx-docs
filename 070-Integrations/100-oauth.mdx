...
Xata offers OAuth 2.0 authentication for external applications. This allows you to use Xata as an identity provider for your application. This is very useful if you're creating an app that uses Xata, and you want to give users the option to log in using their Xata account.

<Alert status="info">
  <strong>OAuth 2.0 is currently in beta.</strong>
  If you are interested in using OAuth 2.0, contact us at <a href="mailto:integrations@xata.io">
