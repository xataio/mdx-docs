...
<Alert status="info">
  ...
  If you are interested in using OAuth2, please contact us at <a href="mailto:integrations@xata.io">
...
| `scope`         | Scopes that the application is requesting. Can be repeated to request multiple scopes. Right now, the only supported scope is `admin:all` and can be ignored as it is the default scope. |
