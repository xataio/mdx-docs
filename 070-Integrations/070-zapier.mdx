...
- Copy content from Google docs into Xata and take advantage of free text [search](/docs/developer-guide/typescript-client/search) and [Ask AI](/docs/developer-guide/typescript-client/ask) features.
- Forward Slack or Discord events, messages, and reactions in order to track [search](/docs/developer-guide/typescript-client/search) or [aggregate](https://xata.io/docs/developer-guide/typescript-client/aggregate) them in Xata.
