...
- Forward Slack or Discord events, messages, and reactions in order to track [search](/typescript-client/search) or [aggregate](https://xata.io/docs/typescript-client/aggregate) them in Xata.
