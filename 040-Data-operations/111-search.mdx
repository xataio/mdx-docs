  ...
  "records": [
    {
      ...
      "xata": {
        "highlight": { // [!code highlight]
          "city": ["<em>New York</em> City"] // [!code highlight]
        }, // [!code highlight]
        "score": 0.2876821,
        "table": "Actors",
        "version": 0
...
const results = await xata.search.all('search term', {
  tables: ['Actors', 'Movies'] // [!code highlight]
});
...
results, _ := searchClient.SearchBranch(context.TODO(), xata.SearchBranchRequest{
  Payload: xata.SearchBranchRequestPayload{
    Query:  "search term",
    Tables: []*xata.SearchBranchRequestTablesItem{ // [!code highlight]
      xata.NewSearchBranchRequestTablesItemFromString("Actors"), // [!code highlight]
      xata.NewSearchBranchRequestTablesItemFromString("Movies"), // [!code highlight]
    }, // [!code highlight]
  },
})
```
...
```ts {1}
const results = await xata.db.Actors.search("search term", { // [!code highlight]
  target: [...],
  filter: {...},
  boosters: [...],
  fuzziness: 1,
...
```python {1}
results = xata.data().search_table("Actors", { # [!code highlight]
  "query": "search term",
  "filter": {...},
  "target": [...],
  "boosters": [...],
...
```jsonc {1}
// POST https://{workspace}.{region}.xata.sh/db/{db}:{branch}/tables/{table}/search // [!code highlight]
{
  "query": "search term",
  "filter": {...},
  "target": [...],
  ...
  "records": [
    {
      ...
      "record": {
        ...
        "name": "Keanu Reeves",
        "photo": { // [!code highlight]
          "name": "img.jpg", // [!code highlight]
          "mediaType": "image/jpeg", // [!code highlight]
          "enablePublicUrl": true, // [!code highlight]
          "signedUrlTimeout": 600, // [!code highlight]
          "uploadUrlTimeout": 86400, // [!code highlight]
          "size": 1, // [!code highlight]
          "version": 0, // [!code highlight]
          "url": "https://us-east-1.storage.xata.sh/f13f4im2411tpd9njp32mgt9fc", // [!code highlight]
          "signedUrl": "https://us-east-1.xata.sh/file/...", // [!code highlight]
          "uploadUrl": "https://q867qv.us-east-1.upload.xata.sh/file/...", // [!code highlight]
          "attributes": { // [!code highlight]
            "height": 3205, // [!code highlight]
            "width": 2561 // [!code highlight]
          } // [!code highlight]
        }, // [!code highlight]
        "xata": {
...
const results = await xata.search.all('search term', {
  tables: [
    {
      table: 'Actors',
      target: ['name', 'city'] // [!code highlight]
    }
  ]
});
```
...
results, _ := searchClient.SearchTable(context.TODO(), xata.SearchTableRequest{
  Payload: xata.SearchTableRequestPayload{
    Query:  *xata.String("search term"),
    Target: []*xata.TargetExpressionItem{ // [!code highlight]
      xata.NewTargetExpression("name"), // [!code highlight]
      xata.NewTargetExpression("city"), // [!code highlight]
    }, // [!code highlight]
  },
})
```
...
const results = await xata.search.all('search term', {
  ...
  page: { // [!code highlight]
    size: 10, // [!code highlight]
    offset: 10 // [!code highlight]
  } // [!code highlight]
});
```
...
const results = await xata.search.all('search term', {
  tables: [
    {
      table: 'Movies',
      target: [{ column: 'title', weight: 5 }, { column: 'genre', weight: 2 }, '*'] // [!code highlight]
    }
  ]
});
```
  ...
  "tables": [
    {
      ...
      "target": [ # [!code highlight]
        { # [!code highlight]
          "column": "title", # [!code highlight]
          "weight": 5 # [!code highlight]
        }, # [!code highlight]
        { # [!code highlight]
          "column": "genre", # [!code highlight]
          "weight": 2 # [!code highlight]
        }, # [!code highlight]
        "*" # [!code highlight]
      ] # [!code highlight]
    }
...
const results = await xata.search.all('search term', {
  tables: [
    {
      table: 'Movies',
      boosters: [{ numericBooster: { column: 'views', factor: 3 } }] // [!code highlight]
    }
  ]
});
```
...
results = xata.data().search_branch({
  ...
  "tables": [
    {
      "table": "Movies",
      "boosters": [ # [!code highlight]
        { # [!code highlight]
          "numericBooster": { # [!code highlight]
            "column": "views", # [!code highlight]
            "factor": 3 # [!code highlight]
          } # [!code highlight]
        } # [!code highlight]
      ] # [!code highlight]
    }
...
const results = await xata.search.all('search term', {
  tables: [
    {
      table: 'Movies',
      boosters: [{ numericBooster: { column: 'views', factor: 3, modifier: 'square' } }] // [!code highlight]
    }
  ]
});
```
      ...
      "boosters": [ # [!code highlight]
        { # [!code highlight]
          "numericBooster": { # [!code highlight]
            "column": "views", # [!code highlight]
            "factor": 3, # [!code highlight]
            "modifier": "square" # [!code highlight]
          } # [!code highlight]
        } # [!code highlight]
      ] # [!code highlight]
    }
...
const results = await xata.search.all('search term', {
  tables: [
    {
      table: 'Movies',
      boosters: [{ valueBooster: { column: 'genre', value: 'action', factor: 5 } }] // [!code highlight]
    }
  ]
});
```
  ...
  "tables": [
    {
      ...
      "boosters": [ # [!code highlight]
        { # [!code highlight]
          "valueBooster": { # [!code highlight]
            "column": "genre", # [!code highlight]
            "value": "action", # [!code highlight]
            "factor": 5 # [!code highlight]
          } # [!code highlight]
        } # [!code highlight]
      ] # [!code highlight]
    }
  ...
  tables: [
    {
      ...
      boosters: [
        {
          dateBooster: { // [!code highlight]
            column: 'xata.createdAt', // [!code highlight]
            decay: 0.5, // [!code highlight]
            scale: '30d', // [!code highlight]
            factor: 10 // [!code highlight]
          } // [!code highlight]
        }
      ]
    }
