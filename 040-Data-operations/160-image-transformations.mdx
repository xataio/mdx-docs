...
xata.files().transform_url("https://us-east-1.storage.xata.sh/4u1fh2o6p10blbutjnphcste94", {
  "height": 100,
  "rotate": 180,
  "format": "webp"
})
...
img = xata.files().transform_url("https://us-east-1.storage.xata.sh/ai4u0uoq297518gmuqboschtcs", {
  "anim": false,
  "format": "auto"
})
```
...
transformImage('https://us-east-1.storage.xata.sh/a3r97ge71h3od25glq8ook1vg8', {
  background: 'pink'
});
```
...
xata.files().transform_url("https://us-east-1.storage.xata.sh/a3r97ge71h3od25glq8ook1vg8", {
  "background": "pink"
})
```
...
img = xata.files().transform_url("https://us-east-1.storage.xata.sh/4u1fh2o6p10blbutjnphcste94", {
  "brightness": 0.5
})
```
...
# Note that the rendered example retains the original aspect-ratio
transformed_image = xata.files().transform_url("https://us-east-1.storage.xata.sh/4u1fh2o6p10blbutjnphcste94", {
  "width": 100,
  "height": 100,
  "fit": "contain"
})
