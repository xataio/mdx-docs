...
For example, the below example shows a method to transform an image in your server side code.
...
// Get a new url and signedUrl for the image in the "imageColumnName"
// This will make a square image that is cropped from the top
