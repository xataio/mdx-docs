...
- **Search engine storage:** 15 GB for searching and storing results. You can use this space for enabling full-text search. Search engine storage currently bundles storage on disk with I/O rates and compute costs. Beyond that, additional search engine storage is available, in which you only pay for the additional storage you use.
