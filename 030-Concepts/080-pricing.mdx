...
Xata sets specific limits to balance workloads across different store types. The concurrency limit depends on the plan and are allocated to each branch:
