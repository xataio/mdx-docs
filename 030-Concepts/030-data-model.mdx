...
Refer to the [many-to-many relationships](/docs/sdk/get#many-to-many-relationships) section for guidance to formulate, join and manage relations via junction tables.
