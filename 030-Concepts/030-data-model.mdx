...
This column is meant to be use for optimistic concurrency control, see the [dedicated section](/docs/sdk/update#optimistic-concurrency-control) for more information.
