...
The folloiwing is an example of adding multiple files in a single column value:
...
### json
The `json` type represents any [RFC 7159](https://www.rfc-editor.org/rfc/rfc7159.html)-compliant JSON document. Input is processed so storage and query operations are performant, therefore, it's useful to keep in mind that:
