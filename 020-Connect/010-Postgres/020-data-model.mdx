...
As you are able to create your own types or use types from extensions through the [wire protocol](/docs/postgres), there is a possibility that the Xata UI is not aware of the type.
