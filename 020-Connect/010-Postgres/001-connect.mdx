...
The table below, is providing a more granularity picture of the supported statements.
...
| `EXECUTE`               | Y             | Y              | Y                 |
| `TRUNCATE`              | Y             | Y              | Y                 |
| `ALTER TABLESPACE`      | N             | N              | Y                 |
| `CREATE TABLESPACE`     | N             | N              | Y                 |
| `DROP TABLESPACE`       | N             | N              | Y                 |
| `ALTER INDEX`           | N             | N              | Y                 |
| `DROP INDEX`            | N             | N              | Y                 |
| `ALTER TRIGGER`         | N             | N              | Y                 |
...
If you face an issue, be append the SSL mode `require` option to the connection string or pass in a parameterized way depending on the tool you are using.
