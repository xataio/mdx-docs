...
The following table illustrates the types can be created, droped and altered in SQL over HTTP, shared and dedicated clusters.

|                                                                          |     | SQL over HTTP | Shared Cluster | Dedicated Cluster |
| ------------------------------------------------------------------------ | --- | ------------- | -------------- | ----------------- |
| [Enumerated](https://www.postgresql.org/docs/current/datatype-enum.html) |     | ✅            | ✅             | ✅                |
