...
If you want control of the version, you should consider a [dedicated cluster](/docs/dedicated-cluster).

### Dedicated cluster

In a [dedicated cluster](/docs/dedicated-cluster), you can select which version you want. The currently supported versions in all [available regions](/docs/getting-started/available-regions) are:
...
If you are on a [dedicated cluster](/docs/dedicated-cluster) you can install extensions yourself, please consult the [Postgres documentation](https://www.postgresql.org/docs/current/sql-createextension.html) for a how to.
