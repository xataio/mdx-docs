...
![Enable Postgres connections in Xata](images/pg-enable.png)
...
For now, existing databases that weren't set up with direct access initially will need to be ported into a brand new database if you wish to utilize these features.
