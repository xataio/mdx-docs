---
title: SQL queries over HTTP
description: How to access Xata using SQL directly over HTTP
...
Please refer to the [supported commands table](/docs/postgres#supported-statements) to get a full break down.
