...
- We provide the binaries in .gz format. The tarball contains Node.js.

- We provide a setup script for Linux users who do not want to extract the tarball themselves:
