...
```sh
curl --create-dirs -o seed/blog-posts.csv https://raw.githubusercontent.com/leggetter/xata-examples/nextjs-getting-started/apps/getting-started-nextjs/seed/blog-posts.csv 
```
