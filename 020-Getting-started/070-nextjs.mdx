...
[`getAll`](https://xata.io/docs/sdk/get#the-typescript-sdk-functions-for-querying) function to get
...
<Alert status="warning">
  ...
  documentation](https://xata.io/docs/sdk/get#the-typescript-sdk-functions-for-querying) for more information.
</Alert>
...
[`filter` function](https://xata.io/docs/sdk/get#the-typescript-sdk-functions-for-querying) is used to query
the table for a row where the `slug` column equals the value of `params. slug`. Finally the
[`getFirst` function](https://xata.io/docs/sdk/get#the-typescript-sdk-functions-for-querying) to return
...
[TypeScript SDK search feature](https://xata.io/docs/sdk/search).
...
[`search` function](https://xata.io/docs/sdk/search#searching-in-a-single-table) exposed on the
...
[fuzziness and typo tolerance](https://xata.io/docs/sdk/search#fuzziness-and-typo-tolerance) for more
details.
...
- Add [pagination](https://xata.io/docs/sdk/get#paginating-results) for the blog post listing
- Add [pagination](https://xata.io/docs/sdk/search#pagination) for blog post search results
...
- [Getting records](https://xata.io/docs/sdk/get)
- [Filtering records](https://xata.io/docs/sdk/filtering)
- [Searching records](https://xata.io/docs/sdk/search)

Or dive into some of Xata's more advanced features, such as:

- [Aggregations](https://xata.io/docs/sdk/aggregate)
- [Transactions](https://xata.io/docs/sdk/transaction)
