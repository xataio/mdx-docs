      ...
      <div className="z-10 h-50 w-full max-w-5xl items-center justify-between text-xl lg:flex">
        ...
        <div className="fixed bottom-0 left-0 flex w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
          <a href="https://xata.io" className="w-20">
            <img src="https://raw.githubusercontent.com/xataio/xata-examples/5b0715c9ba36556400b6121bd224203cb89f7741/docs/app_logo.svg" />
          </a>
        </div>
      </div>
...
achieved via the auto-generated `Posts` property which exposes a number of helper functions. In this case, we use the [`getAll`](https://xata.io/docs/sdk/get#the-typescript-sdk-functions-for-querying) function to get all the Post records.
...
<Alert status="warning">
  ...
  documentation](https://xata.io/docs/sdk/get#the-typescript-sdk-functions-for-querying)
...
any configuration to enable search, we just need to use the [TypeScript SDK search feature](https://xata.io/docs/sdk/search).
