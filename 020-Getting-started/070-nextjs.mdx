...
This error occurs because Xata stores date fields as an object. To resolve this issue, use the `toSerializable` function that is provided by the SDK. This will convert the record into a JSON serializable object.
