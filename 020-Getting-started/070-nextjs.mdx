...
And login to your Xata account with the Xata CLI. Running the following command will open a new browser window. If
you're not already logged into Xata you can go through the login or signup process. Run the following command to begin
