...
1. In the _Workflow integrations_ section, click **Vercel** from the listed integration options, then click **Install the Xata app on Vercel**  on the _Setup Vercel integration_ page. This directs you to Vercel's website.
1. After clicking **Add Integration**, you can select where to add the integration to. Your personal account and your team's organization account are listed. 
1. If  prompted, you can select the individual projects to which the integration will be added or add the integration globally.
...
1. After you've cleared these variables, apply the integration. The integration will automatically manage these environment variables for you.
