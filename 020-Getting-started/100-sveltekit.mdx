...
Let's add this functionality to the landing page server functionality:
...
With the browser default behavior set, and the check for the `q` querystring search value has been already implemented, everything is in place.
