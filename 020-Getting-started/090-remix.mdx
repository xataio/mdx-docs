...
Now you're ready to integrate Xata into the Remix codebase. Let's start by stripping back the landing page,
...
The `params` property on `LoaderArgs` gives you the slug value from the URL via `params.slug`.
