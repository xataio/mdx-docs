...
It is recommended to exclude the `.env` file from your repository commits, as it contains your API key. Add the `.env` file to your `.gitignore` to ensure it is not accidentally committed and remains secure.
