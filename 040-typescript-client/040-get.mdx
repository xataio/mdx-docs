---
title: Gettings records with TypeScript
navTitle: Gettings records
...
You can find more infromation about pagination in the [API reference](/docs/api-reference/db/db_branch_name/tables/table_name/query#pagination).
...
<TabbedCode tabs={['TypeScript', 'Pyton', 'JSON']}>
```ts
const page = await xata.db.Users.getPaginated({
